...
if ($_SERVER['REQUEST_METHOD']=='GET') {
    if (isset($_GET['id'])) {
        $sql=$pdo->prepare("SELECT * FROM venta_detalle WHERE det_id=:id");
...
if ($_SERVER['REQUEST_METHOD']=='POST') {
    $sql="INSERT INTO venta_detalle(venta_id, prod_id, cantidad_venta, precio_venta, descuento) 
    VALUES(:venta, :producto, :cantidad, :precio, :descuento)";
